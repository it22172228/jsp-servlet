...
@WebServlet("/UpdateComplaintsControl")
public class UpdateComplaintsControl extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		isTrue = UserDBUtill.updateComplaints(id,name, email, complaint,respons);
